...
public:
    ...
    void RenderRoundedRect(float x, float y, float width, float height, const Vector3& color, float alpha = 1.0f, float radius = 0.0f, bool stripes = false, int corners = 15);
